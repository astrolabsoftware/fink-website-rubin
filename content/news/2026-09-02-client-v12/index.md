...
You should see the help menu, together with the version of the client. Get more information online from the [ZTF](https://doc.ztf.fink-broker.org/services/fink_client/) or [LSST](https://doc.lsst.fink-broker.org/services/fink_client/) documentation websites.
